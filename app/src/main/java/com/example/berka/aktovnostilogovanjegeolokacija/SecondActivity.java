...
import com.example.berka.aktovnostilogovanjegeolokacija.service.FetchAddressIntentService;
...
public class SecondActivity extends AppCompatActivity {
    ...
    /**
     * Receiver registered with this activity to getf the response from FetchAddressIntentService.
     */
    ...
    private EditText et_cargo, et_fellow;
    private ProgressBar progressBar;
    private Button btn_find_address, btn_send_data;
    private TextView tv_name,tv_email, tv_location;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_location = (TextView) findViewById(R.id.location_address_tv);

        et_cargo = (EditText) findViewById(R.id.et_cargo);
        et_fellow = (EditText) findViewById(R.id.et_fellow);

        progressBar = (ProgressBar) findViewById(R.id.progress_bar);

        btn_find_address = (Button) findViewById(R.id.fetch_address_button);
        ...
        btn_send_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String fellow = et_fellow.getText().toString();
                String cargo = et_cargo.getText().toString();


                if(!location.isEmpty() && !fellow.isEmpty() && cargo.isEmpty()){

                    progressBar.setVisibility(View.VISIBLE);
                    sendDataProcess(location,fellow,cargo);
                }else
                {
...
//        btn_find_address.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//
...
//        });
    ...
    private void LoadPreferences(){
        ...
        String userId = sharedPreferences.getString(Constants.UNIQUE_ID, "");
        ...
        if (savedInstanceState != null) {
            ...
            if (savedInstanceState.keySet().contains(LOCATION_ADDRESS_KEY)) {
                ...
                displayAddressOutput();
                        ...
                        //////OVO JE POD ZNAKOM PITANJA MOZDA BUDEM MORAO DA KORSITIL LISTENER
    /**
    ...
    private void startIntentService() {
        ...
        Intent intent = new Intent(SecondActivity.this, FetchAddressIntentService.class);
    ...
    private void getAddress() {
        mFusedLocationClient.getLastLocation()
                ...
                .addOnFailureListener(SecondActivity.this, new OnFailureListener() {
                    @Override
    ...
    private void updateUIWidgets() {
        if (mAddressRequested) {
            ...
            btn_find_address.setEnabled(false);
        } else {
            progressBar.setVisibility(ProgressBar.GONE);
            btn_find_address.setEnabled(true);
        }
    }
    ...
    private class AddressResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int resultCode, Bundle resultData) {
            ...
            if (resultCode == Constants.SUCCESS_RESULT) {
                ...
                Log.i("Nadjena adressa", "odgovor sa intenta");
            }
    ...
    private void sendDataProcess(String address, String cargo, String fellow){
        ...
        sendData.setSendAddress(address);
        sendData.setSendCargo(cargo);
        sendData.setSendFellow(fellow);
        //sendData.setUser(user);

        ServerRequest serverRequest = new ServerRequest();
        serverRequest.setOperation(Constants.SEND_DATA_OPERATION);
        serverRequest.setSendData(sendData);
        Call<ServerResponse> response = requestInterface.operationSend(serverRequest);
